...
OrgChart.prototype.load = function (t) { return this.config.nodes = t, this._draw(!1, OrgChart.action.init), this; }, OrgChart.prototype.loadXML = function (t) { var e = OrgChart._xml2json(t); this.load(e); }, OrgChart.prototype.getXML = function () { return OrgChart._json2xml(this.config.nodes); }, OrgChart.prototype.on = function (t, e) { return OrgChart.events.on(t, e, this._event_id), this; }, OrgChart.prototype.draw = function (t, e, r) { null == t && (t = OrgChart.action.update), this._draw(!1, t, e, r); }, OrgChart.prototype._get = function (t) { for (var e = 0; e < this.config.nodes.length; e++)
...
} e = { content: r, res: t }; if (OrgChart.events.publish("render", [b, e]), r = e.content, r += b.ui.lonely(b.config), v !== OrgChart.action.exporting) {
    ...
    if (0 < p[0].length) {
        ...
        OrgChart.anim(p[0], p[1], p[2], b.config.anim.duration, b.config.anim.func, function () { g || (y && y(), OrgChart.events.publish("redraw", [b]), b._showAfterAnimation(), g = !0); });
    }
    v === OrgChart.action.centerNode ? OrgChart.anim(b.getSvg(), { viewbox: a }, { viewbox: b.response.viewBox }, b.config.anim.duration, b.config.anim.func, function () { b.ripple(x.options.rippleId), g || (y && y(), OrgChart.events.publish("redraw", [b]), b._showAfterAnimation(), g = !0); }, function () { b.xScrollUI.setPosition(), b.yScrollUI.setPosition(); }) : !a || !b.response || a[0] == b.response.viewBox[0] && a[1] == b.response.viewBox[1] && a[2] == b.response.viewBox[2] && a[3] == b.response.viewBox[3] || v !== OrgChart.action.insert && v !== OrgChart.action.expandCollapse && v !== OrgChart.action.update && v !== OrgChart.action.init ? 0 == p[0].length && (g || (y && y(), OrgChart.events.publish("redraw", [b]), g = !0)) : OrgChart.anim(b.getSvg(), { viewbox: a }, { viewbox: b.response.viewBox }, 500, OrgChart.anim.inOutPow, function () { b.xScrollUI.setPosition(), b.yScrollUI.setPosition(), g || (y && y(), OrgChart.events.publish("redraw", [b]), g = !0); }), b._initialized = !0;
}
else {
    var u = t.boundary, C = u.maxX - u.minX, m = u.maxY - u.minY, O = b.ui.svg(C, m, [u.minX, u.minY, C, m], b.config, r, i);
    y(O);
} }, function (t) { OrgChart.events.publish("ready", [b, t]); }); }, OrgChart.prototype._setInitialSizeIfNotSet = function () { this.element.style.overflow = "hidden", this.element.style.position = "relative", 0 == this.element.offsetHeight && (this.element.style.height = "100%", 0 == this.element.offsetHeight && (this.element.style.height = "700px")), 0 == this.element.offsetWidth && (this.element.style.width = "100%", 0 == this.element.offsetWidth && (this.element.style.width = "700px")); }, OrgChart.prototype.getViewBox = function () { var t = this.getSvg(), e = null; return t ? (e = (e = "[" + (e = t.getAttribute("viewBox")) + "]").replace(/\ /g, ","), e = JSON.parse(e)) : null; }, OrgChart.prototype.setViewBox = function (t) { this.getSvg().setAttribute("viewBox", t.toString()); }, OrgChart.prototype.width = function () { return this.element.offsetWidth; }, OrgChart.prototype.height = function () { return this.element.offsetHeight; }, OrgChart.prototype.getScale = function (t) { return t || (t = this.getViewBox()), OrgChart.getScale(t, this.width(), this.height(), this.config.scaleInitial); }, OrgChart.prototype.ripple = function (t, e, r) { var i = this.getBGNode(t); if (null != i) {
    ...
    if (null != a) {
        ...
        var h = i.w, d = i.h, c = o < h - o ? h - o : o, g = l < d - l ? d - l : l, p = (g = g) < (c = c) ? c : g, f = document.createElementNS("http://www.w3.org/2000/svg", "g"), u = document.createElementNS("http://www.w3.org/2000/svg", "clipPath"), C = document.createElementNS("http://www.w3.org/2000/svg", "rect"), m = document.createElementNS("http://www.w3.org/2000/svg", "circle"), O = OrgChart._randomId();
        u.setAttribute("id", O);
        var v = OrgChart.t(i.templateName, this.getScale());
        C.setAttribute("x", v.ripple.rect ? v.ripple.rect.x : 0), C.setAttribute("y", v.ripple.rect ? v.ripple.rect.y : 0), C.setAttribute("width", v.ripple.rect ? v.ripple.rect.width : i.w), C.setAttribute("height", v.ripple.rect ? v.ripple.rect.height : i.h), C.setAttribute("rx", v.ripple.radius), C.setAttribute("ry", v.ripple.radius), m.setAttribute("clip-path", "url(#" + O + ")"), m.setAttribute("cx", o), m.setAttribute("cy", l), m.setAttribute("r", 0), m.setAttribute("fill", v.ripple.color), u.appendChild(C), f.appendChild(u), f.appendChild(m), a.appendChild(f), OrgChart.anim(m, { r: 0, opacity: 1 }, { r: p, opacity: 0 }, 500, OrgChart.anim.outPow, function () { a.removeChild(f); });
    }
} }, OrgChart.prototype.center = function (t, e, r) { var i, a, n = t, o = !0, l = !0; e && null != e.parentState && (i = e.parentState), e && null != e.childrenState && (a = e.childrenState), e && null != e.rippleId && (n = e.rippleId), e && null != e.vertical && (o = e.vertical), e && null != e.horizontal && (l = e.horizontal); var s = { parentState: i, childrenState: a, rippleId: n, vertical: o, horizontal: l }; this._draw(!1, OrgChart.action.centerNode, { id: t, options: s }, r); }, OrgChart.prototype.fit = function (t) { this.config.scaleInitial = OrgChart.match.boundary, this._draw(!0, OrgChart.action.init, void 0, t); }, OrgChart.prototype.getBGNode = function (t) { var e = this.nodes[t]; if (null == e)
    for (var r in this.nodes)
        for (var i = this.nodes[r].bgnodes, a = 0; a < i.length; a++)
            if (i[a].id == t)
                return i[a]; return e; }, OrgChart.prototype.setLayout = function (t) { this.config.layout = t, this._draw(!1, OrgChart.action.update); }, OrgChart.prototype.find = function (t) { return this.server.find(t); }, OrgChart.prototype._hideBeforeAnimation = function (t) { if (1 != this._hideBeforeAnimationCompleted && !(t && t < OrgChart.ANIM_THRESHOLD)) {
...
} }, OrgChart.prototype._showAfterAnimation = function () { for (var t = this.element.getElementsByTagName("text"), e = 0; e < t.length; e++)
    t[e].style.display = ""; var r = this.element.getElementsByTagName("image"); for (e = 0; e < r.length; e++)
    r[e].style.display = ""; var i = this.element.querySelectorAll("[link-id]"); for (e = 0; e < i.length; e++)
    i[e].style.display = ""; var a = this.element.querySelectorAll("[control-expcoll-id]"); for (e = 0; e < a.length; e++)
    a[e].style.display = ""; this._hideBeforeAnimationCompleted = !1; }, (BALKANGraph = OrgChart).prototype._canUpdateLink = function (t, e) { if (null == e || null == e)
    return !1; if (null == t || null == t)
    return !1; if (t == e)
    return !1; for (var r = this.getBGNode(t), i = !1, a = this.getBGNode(e).parent; null != a;) {
    if (a == r) {
        i = !0;
        break;
    }
    a = a.parent;
} return !i; }, OrgChart.prototype.link = function (t, e) { if (this._canUpdateLink(t, e)) {
    var r = this.get(t);
    r.pid = e, this.update(r, !0);
} }, OrgChart.prototype.linkNode = function (t, e) { if (this._canUpdateLink(t, e)) {
    ...
    var l = this;
    this._draw(!1, OrgChart.action.update, { visId: t }, function () { l.ripple(r.id); });
} }, OrgChart.prototype.updateNode = function (t, e) { var r = this; if (this.update(t, e)) {
    var i = t.pid;
    null != i && null != i && "" != i || (i = t.id), this._draw(!1, OrgChart.action.update, { id: i }, function () { r.ripple(t.id); });
} }, OrgChart.prototype.update = function (t, e) { var r = this.get(t.id); if (!0 === e && !1 === OrgChart.events.publish("update", [this, r, t]))
    return !1; for (var i = 0; i < this.config.nodes.length; i++)
    this.config.nodes[i].id == t.id && (this.config.nodes[i] = t); return !0; }, OrgChart.prototype.removeNode = function (t, e) { var r = this; this.remove(t, e), this._draw(!1, OrgChart.action.update, null, function () { r.config.sticky && OrgChart._moveToBoundaryArea(r.getSvg(), r.getViewBox(), r.response.boundary); }); }, OrgChart.prototype.remove = function (t, e) { var r = this.getBGNode(t); if ((r.isChildOfGroup && this._removeGroupIfHasOneNode(r._groupParentNodeId, r.id), !0 === e) && !1 === OrgChart.events.publish("remove", [this, t]))
    return !1; for (var i = null, a = this.config.nodes.length - 1; 0 <= a; a--)
    if (this.config.nodes[a].id == t) {
        i = this.config.nodes[a].pid, this.config.nodes.splice(a, 1);
        break;
    } var n = this.getByParentId(t); for (a = n.length - 1; 0 <= a; a--)
    n[a].pid = i, this.update(n[a], e); }, OrgChart.prototype.addNode = function (t, e) { this.add(t, e); var r = OrgChart.action.insert; null != t.pid && null != t.pid || (r = OrgChart.action.update); var i = this.getBGNode(t.pid), a = t.pid; i && i.isChildOfGroup && (a = i._groupParentNodeId), this._draw(!1, r, { id: a, insertedNodeId: t.id }); }, OrgChart.prototype.add = function (t, e) { if ((null == t.id && console.error("Call addNode without id"), !0 === e) && !1 === OrgChart.events.publish("add", [this, t]))
    return !1; this.config.nodes.push(t); }, OrgChart.prototype.addTag = function (t, e, r) { var i = JSON.parse(JSON.stringify(this.config.tags)); if ((i[t] = e, !0 === r) && !1 === OrgChart.events.publish("updatetags", [this, i]))
    return !1; this.config.tags = i; }, OrgChart.prototype.hasTag = function (t) { return null != this.config.tags[t]; }, OrgChart.prototype.removeTag = function (t, e) { var r = JSON.parse(JSON.stringify(this.config.tags)); if ((delete r[t], !0 === e) && !1 === OrgChart.events.publish("updatetags", [this, r]))
    return !1; this.config.tags = r; }, OrgChart.prototype._updateTag = function (t, e, r) { var i = JSON.parse(JSON.stringify(this.config.tags)); if (i[t][e] = r, !1 === OrgChart.events.publish("updatetags", [this, i]))
    return !1; this.config.tags = i; var a = this; this._draw(!1, OrgChart.action.update, { id: t }, function () { a.ripple(t); }); }, OrgChart.prototype.addNodeTag = function (t, e, r) { var i = this.get(t); Array.isArray(i.tags) || (i.tags = []), -1 == i.tags.indexOf(e) && (i.tags.push(e), this.update(i, r)); }, OrgChart.prototype.removeNodeTag = function (t, e, r) { var i = this.get(t); if (Array.isArray(i.tags)) {
    var a = i.tags.indexOf(e);
    -1 != a && (i.tags.splice(a, 1), this.update(i, r));
} }, OrgChart.prototype._removeGroupIfHasOneNode = function (t, e) { if (OrgChart.REMOVE_GROUP_IF_HAS_ONE_NODE) {
...
} }, OrgChart.prototype.group = function (t, e) { var r = this.getBGNode(t), i = this.getBGNode(e), a = this, n = i.id; if (r.isGroup || i.isGroup || r.isChildOfGroup || i.isChildOfGroup)
    if (r.isGroup || i.isGroup || !r.isChildOfGroup || i.isChildOfGroup)
        if (r.isGroup || i.isGroup || r.isChildOfGroup || !i.isChildOfGroup)
            if (!r.isGroup && !i.isGroup && r.isChildOfGroup && i.isChildOfGroup)
                this._removeGroupIfHasOneNode(r._groupParentNodeId, r.id), this.removeNodeTag(r.id, r._groupParentNodeId, !0), this.addNodeTag(r.id, i._groupParentNodeId, !0), this.link(r.id, i.pid);
            else if (!r.isGroup && i.isGroup && r.isChildOfGroup && !i.isChildOfGroup)
                this._removeGroupIfHasOneNode(r._groupParentNodeId, r.id), this.removeNodeTag(r.id, r._groupParentNodeId, !0), this.addNodeTag(r.id, i.id, !0);
            else if (r.isGroup || !i.isGroup || r.isChildOfGroup || i.isChildOfGroup) {
                if (r.isGroup && i.isGroup && !r.isChildOfGroup && !i.isChildOfGroup)
                    for (var o = 0; o < r.bgnodes.length; o++)
                        this.removeNodeTag(r.bgnodes[o].id, r.id, !0), this.addNodeTag(r.bgnodes[o].id, i.id, !0);
            }
            else
                this.addNodeTag(r.id, i.id, !0);
        else
            this.addNodeTag(r.id, i._groupParentNodeId, !0), this.link(r.id, i.pid);
    else {
        l = OrgChart._randomId();
        this.addTag(l, { group: !0, groupName: "", groupState: OrgChart.EXPAND, template: "group_grey" }, !0), this._removeGroupIfHasOneNode(r._groupParentNodeId, r.id), this.removeNodeTag(r.id, r._groupParentNodeId, !0), this.addNodeTag(r.id, l, !0), this.addNodeTag(i.id, l, !0);
    }
else {
    var l = OrgChart._randomId();
    this.addTag(l, { group: !0, groupName: "", groupState: OrgChart.EXPAND, template: "group_grey" }, !0), this.addNodeTag(r.id, l, !0), this.addNodeTag(i.id, l, !0);
    var s = this._get(i.id).pid;
    this.link(r.id, s);
} this._draw(!1, OrgChart.action.update, { id: n }, function () { a.ripple(r.id); }); }, void 0 === OrgChart && (OrgChart = {}), OrgChart._ajax = function (t, e, r, i, a) { null == i && (i = "arraybuffer"); var n = new XMLHttpRequest; n.onload = function (t) { n.readyState == XMLHttpRequest.DONE && 200 === this.status && a(t.target.response); }, n.onerror = function (t) { a({ error: t }); }, n.open(e, t), n.responseType = i, n.setRequestHeader("Content-Type", "application/json"), null == r ? n.send() : n.send(r); }, void 0 === OrgChart && (OrgChart = {}), OrgChart.anim = function (c, g, p, f, u, C, m) { var O, v = 1, x = f / 10 + 1; document.getElementsByTagName("g"); Array.isArray(c) || (c = [c]), Array.isArray(g) || (g = [g]), Array.isArray(p) || (p = [p]), O = setInterval(function () { for (var t = 0; t < c.length; t++)
    for (var e in p[t]) {
        var r = OrgChart._arrayContains(["top", "left", "right", "bottom", "width", "height"], e.toLowerCase()) ? "px" : "";
        switch (e.toLowerCase()) {
            case "d":
                var a = u((10 * v - 10) / f) * (p[t][e][0] - g[t][e][0]) + g[t][e][0], n = u((10 * v - 10) / f) * (p[t][e][1] - g[t][e][1]) + g[t][e][1];
            ...
            case "viewbox":
                if (p[t][e]) {
                    for (i in l = g[t][e], s = p[t][e], h = [0, 0, 0, 0], l)
                        h[i] = u((10 * v - 10) / f) * (s[i] - l[i]) + l[i];
...
} t.isGroup || t.isChildOfGroup || 0 != t.childrenIds.length || o.appendChild(l), t.isGroup || o.appendChild(n), this.obj.element.appendChild(this.wrapperElement), r.addEventListener("click", function () { i.hide(!0); }), n.addEventListener("click", function () { if ("Save" == n.innerHTML)
    OrgChart.anim(n, { opacity: 1 }, { opacity: 0 }, 200, OrgChart.anim.inSin, function () { n.innerHTML = "Add new field", n.style.textAlign = "left"; var t = document.getElementById("bgNewField"), e = t.getElementsByTagName("input")[0].value; if (o.removeChild(t), e && !OrgChart._arrayContains(i.fields, e)) {
        var r = OrgChart.input(e);
        r.style.opacity = 0, o.insertBefore(r, n), OrgChart.anim(r, { opacity: 0 }, { opacity: 1 }, 200, OrgChart.anim.inSin, function () { r.getElementsByTagName("input")[0].focus(); });
    } OrgChart.anim(n, { opacity: 0 }, { opacity: 1 }, 200, OrgChart.anim.inSin); });
else {
    OrgChart.anim(n, { opacity: 1 }, { opacity: 0 }, 200, OrgChart.anim.inSin, function () { n.innerHTML = "Save", n.style.textAlign = "right", OrgChart.anim(n, { opacity: 0 }, { opacity: 1 }, 200, OrgChart.anim.inSin); });
    var t = OrgChart.input(null, null, "Field name");
    t.style.opacity = 0, t.id = "bgNewField", o.appendChild(t), OrgChart.anim(t, { opacity: 0 }, { opacity: 1 }, 200, OrgChart.anim.inSin, function () { t.getElementsByTagName("input")[0].focus(); });
} }), this.obj._hideBeforeAnimation(), OrgChart.anim(this.wrapperElement, { right: -150, opacity: 0 }, { right: 0, opacity: .9 }, 300, OrgChart.anim.inOutSin, function () { i.obj._showAfterAnimation(), o.style.height = i.obj.element.offsetHeight - r.offsetHeight + "px", 1 < i.wrapperElement.getElementsByTagName("input").length && i.wrapperElement.getElementsByTagName("input")[0].focus(); }); }, OrgChart.editUI.prototype.hide = function (t) { if (this.wrapperElement) {
    ...
    this.wrapper = document.createElement("div"), Object.assign(this.wrapper.style, { opacity: 0, "background-color": "#FFFEFF", "box-shadow": "#DCDCDC 0px 1px 2px 0px", display: "inline-block", border: "1px solid #D7D7D7;border-radius:5px", "z-index": 1e3, position: "absolute", "text-align": "left", "user-select": "none" });
    var c = t + 45;
    this.wrapper.style.left = c + "px", this.wrapper.style.top = e + "px", this.wrapper.innerHTML = r, this.obj.element.appendChild(this.wrapper), this.wrapper.style.left = c - this.wrapper.offsetWidth + "px";
    var g = t - this.wrapper.offsetWidth;
    OrgChart.anim(this.wrapper, { opacity: 0, left: c - this.wrapper.offsetWidth }, { opacity: 1, left: g }, 300, OrgChart.anim.inOutPow);
    for (var p = this.wrapper.getElementsByTagName("div"), f = 0; f < p.length; f++) {
        (a = p[f]).addEventListener("mouseover", function () { this.style.backgroundColor = "#F0F0F0"; }), a.addEventListener("mouseleave", function () { this.style.backgroundColor = "#FFFFFF"; }), a.addEventListener("click", function (t) { var e, r = this.getAttribute("data-item"); if (void 0 === l[r].onClick)
            if ("add" === r) {
                ...
                "remove" === r ? s.obj.removeNode(n, !0) : "svg" === r ? s.obj.exportSVG({ filename: "OrgChart.svg", expandChildren: !1, nodeId: n }) : "pdf" === r ? s.obj.exportPDF({ filename: "OrgChart.pdf", expandChildren: !1, nodeId: n }) : "png" === r ? s.obj.exportPNG({ filename: "OrgChart.png", expandChildren: !1, nodeId: n }) : "csv" === r ? s.obj.exportCSV() : "addInGroup" === r ? s.obj.group(n, o) : "addAsChild" === r && s.obj.linkNode(n, o);
        else
            e = l[r].onClick.call(s.obj, n, o); 0 != e && s.hide(); });
    }
} }, OrgChart.menuUI.prototype.hide = function () { null != this.wrapper && (this.obj.element.removeChild(this.wrapper), this.wrapper = null); }, OrgChart.menuUI.prototype.on = function (t, e) { return OrgChart.events.on(t, e, this._event_id), this; }, void 0 === OrgChart && (OrgChart = {}), OrgChart.idb = { version: 1, dbName: "balkangraph", tableName: "orgchart-js", keyPath: "id" }, window.indexedDB = window.indexedDB || window.mozIndexedDB || window.webkitIndexedDB || window.msIndexedDB, OrgChart.idb.db = null, OrgChart.idb._open = function (e) { if ((0 < navigator.userAgent.toLowerCase().indexOf("safari") || 0 < navigator.userAgent.toLowerCase().indexOf("firefox")) && window.location !== window.parent.location)
    e && e(!1);
else {
    if (!window.indexedDB)
...
} }, OrgChart.toolbarUI.prototype.showLayout = function () { this._visible = !0, this.layoutBtn.style.transform = "rotate(180deg) translateX(0px) translateY(0px)", OrgChart.anim(this.div, { bottom: this.obj.config.padding }, { bottom: this.obj.config.padding + 145 }, this.obj.config.anim.duration, this.obj.config.anim.func), OrgChart.anim(this.layouts, { bottom: -145 }, { bottom: 0 }, this.obj.config.anim.duration, this.obj.config.anim.func); }, OrgChart.toolbarUI.prototype.hideLayout = function () { this._visible = !1, this.layoutBtn.style.transform = "rotate(0deg) translateX(0px) translateY(0px)", OrgChart.anim(this.div, { bottom: this.obj.config.padding + 145 }, { bottom: this.obj.config.padding }, this.obj.config.anim.duration, this.obj.config.anim.func), OrgChart.anim(this.layouts, { bottom: 0 }, { bottom: -145 }, this.obj.config.anim.duration, this.obj.config.anim.func); }, OrgChart.notifierUI = function () { }, OrgChart.notifierUI.prototype.init = function (t) { this.obj = t; }, OrgChart.notifierUI.prototype.show = function (t, e) { if (null != t) {
    1 == t && (t = OrgChart.MAX_NODES_MESS, e = "#FFCA28"), 2 == t && (t = OrgChart.OFFLINE_MESS, e = "#FFCA28");
    var r = document.createElement("div");
    r.innerHTML = t, Object.assign(r.style, { position: "absolute", "background-color": e, color: "#ffffff", padding: "15px", "border-radius": "40px", opacity: 0, overflow: "hidden", "white-space": "nowrap", "text-align": "center" }), this.obj.element.appendChild(r);
...
} return t; }, OrgChart.prototype._export = function (i, a) { var n = this, t = { id: i.nodeId, expandChildren: i.expandChildren }; this._draw(!1, OrgChart.action.exporting, t, function (t) { var r = document.createElement("div"); if (r.innerHTML = t, "svg" == i.ext)
    if (a)
        a(i, r.innerHTML);
    else {
        ...
        if (!1 === e)
            return !1;
        if (OrgChart._downloadFile(i.mime, r.innerHTML, i.filename), !1 === (e = OrgChart.events.publish("exportend", [n, i, r.innerHTML])))
            return !1;
    }
else
    OrgChart._imgs2base64(r, "image", "xlink:href", function () { n._pages(i, r.querySelector("svg"), function (t) { var e = { content: r.innerHTML, options: i, pages: t }; if (!1 === OrgChart.events.publish("exportstart", [n, e]))
        return !1; a || OrgChart.loading.show(n), a ? a(n, e, r.querySelector("svg")) : (e = JSON.stringify(e), OrgChart._ajax(n.config.exportUrl + "/v3", "POST", e, "arraybuffer", function (t) { if (!1 === OrgChart.events.publish("exportend", [n, t]))
        return !1; OrgChart.loading.hide(n), OrgChart._downloadFile(i.mime, t, i.filename); })); }); }); }); }, OrgChart.prototype.exportCSV = function (t) { if (t || (t = "OrgChart.csv"), !1 === OrgChart.events.publish("exportstart", [this, "csv", t]))
    return !1; var e = OrgChart._json2csv(this.config.nodes); if (!1 === OrgChart.events.publish("exportend", [this, "csv", t, e]))
    return !1; OrgChart._downloadFile("text/csv;charset=utf-8;", e, t); }, OrgChart.prototype.exportXML = function (t) { if (t || (t = "OrgChart.xml"), !1 === OrgChart.events.publish("exportstart", [this, "xml", t]))
    return !1; var e = OrgChart._json2xml(this.config.nodes); if (!1 === OrgChart.events.publish("exportend", [this, "xml", t, e]))
    return !1; OrgChart._downloadFile("application/xml", e, t); }, OrgChart.prototype._pages = function (t, e, r) { "fit2Levels" == t.format ? this._pagesFit2Levels(t, r) : "A42Levels" == t.format || "A32Levels" == t.format || "A22Levels" == t.format || "A12Levels" == t.format ? this._pagesA2Levels(t, r) : "A4" == t.format && 100 == t.scale || "A3" == t.format && 100 == t.scale || "A2" == t.format && 100 == t.scale || "A1" == t.format && 100 == t.scale ? r(this._pagesA100(t, e)) : "A4" == t.format && "fit" == t.scale || "A3" == t.format && "fit" == t.scale || "A2" == t.format && "fit" == t.scale || "A1" == t.format && "fit" == t.scale ? r(this._pagesAfit(t, e)) : "fit" == t.format && r(this._pagesFit(t, e)); }, OrgChart.prototype._pagesA2Levels = function (o, l) { var s = this, h = this.config.collapse, d = this.config.roots; this.config.collapse = { level: 2 }; var t = { id: o.nodeId, expandChildren: o.expandChildren }, c = [], g = []; for (var e in this.nodes) {
    0 != (i = this.nodes[e]).childrenIds.length && g.push(i.id);
} for (var r = 0; r < g.length; r++) {
    e = g[r];
    var i = this.nodes[e];
    this.config.roots = [i.id], function (r) { s._draw(!1, OrgChart.action.exporting, t, function (t) { var a, n, e = document.createElement("div"); e.innerHTML = t, a = e, n = r, OrgChart._imgs2base64(a, "image", "xlink:href", function () { for (var t = a.querySelector("svg"), e = s._pagesAfit(o, t), r = 0; r < e.length; r++) {
        var i = e[r];
        i.html = a.innerHTML, c.push(i);
    } g.length - 1 == n && (s.config.collapse = h, s.config.roots = d, l(c)); }); }); }(r);
} }, OrgChart.prototype._pagesFit2Levels = function (o, l) { var s = this, h = this.config.collapse, d = this.config.roots; this.config.collapse = { level: 2 }; var t = { id: o.nodeId, expandChildren: o.expandChildren }, c = [], g = []; for (var e in this.nodes) {
    var r = this.nodes[e];
    0 != r.childrenIds.length && g.push(r.id);
} for (var i = 0; i < g.length; i++) {
    e = g[i];
    this.config.roots = [e], function (r) { s._draw(!1, OrgChart.action.exporting, t, function (t) { var a, n, e = document.createElement("div"); e.innerHTML = t, a = e, n = r, OrgChart._imgs2base64(a, "image", "xlink:href", function () { for (var t = a.querySelector("svg"), e = s._pagesFit(o, t), r = 0; r < e.length; r++) {
        var i = e[r];
        i.html = a.innerHTML, c.push(i);
    } g.length - 1 == n && (s.config.collapse = h, s.config.roots = d, l(c)); }); }); }(i);
} }, OrgChart.prototype._pagesFit = function (t, e) { var r = e.getAttribute("width"), i = e.getAttribute("height"), a = OrgChart.pdfPrevUI._getViewBox(e), n = { w: parseFloat(r), h: parseFloat(i) }; return [{ vb: a, size: { w: n.w + (t.margin[1] + t.margin[3]), h: n.h + (t.margin[0] + t.margin[2]) }, innerSize: n }]; }, OrgChart.prototype._pagesAfit = function (t, e) { var r = e.getAttribute("width"), i = e.getAttribute("height"), a = 0, n = 0; switch (t.format) {
    case "A4":
    case "A42Levels":
        a = OrgChart.A4w, n = OrgChart.A4h;
        break;
    case "A3":
    case "A32Levels": a = OrgChart.A3w, n = OrgChart.A3h;
    case "A2":
    case "A22Levels": a = OrgChart.A2w, n = OrgChart.A2h;
    case "A1":
    case "A12Levels": a = OrgChart.A1w, n = OrgChart.A1h;
} var o = OrgChart.pdfPrevUI._getViewBox(e), l = { w: t.landscape ? n - (t.margin[1] + t.margin[3]) : a - (t.margin[1] + t.margin[3]), h: t.landscape ? a - (t.margin[0] + t.margin[2]) : n - (t.margin[0] + t.margin[2]) }, s = { w: t.landscape ? n : a, h: t.landscape ? a : n }, h = r / l.w, d = i / l.h, c = d < h ? h : d, g = o[0], p = o[1] / c, f = o[2], u = o[3] / c; e.setAttribute("width", l.w), e.setAttribute("height", l.h), e.setAttribute("preserveAspectRatio", "xMidYMin meet"); for (var C = l.h, m = g, O = p, v = []; O < u;) {
    var x = [m, O * c, f, u];
    x = x.join(), v.push({ vb: x, innerSize: l, size: s }), O += l.h, i < (C += l.h) && (C = i);
} return v; }, OrgChart.prototype._pagesA100 = function (t, e) { var r = e.getAttribute("width"), i = e.getAttribute("height"), a = OrgChart.pdfPrevUI._getViewBox(e), n = 0, o = 0; switch (t.format) {
    case "A4":
    case "A42Levels":
        n = OrgChart.A4w, o = OrgChart.A4h;
        break;
    case "A3":
    case "A32Levels": n = OrgChart.A3w, o = OrgChart.A3h;
    case "A2":
    case "A22Levels": n = OrgChart.A2w, o = OrgChart.A2h;
    case "A1":
    case "A12Levels": n = OrgChart.A1w, o = OrgChart.A1h;
} var l = a[0], s = a[1], h = a[2], d = a[3], c = { w: t.landscape ? o - (t.margin[1] + t.margin[3]) : n - (t.margin[1] + t.margin[3]), h: t.landscape ? n - (t.margin[0] + t.margin[2]) : o - (t.margin[0] + t.margin[2]) }, g = { w: t.landscape ? o : n, h: t.landscape ? n : o }; e.setAttribute("preserveAspectRatio", "xMinYMin slice"), e.setAttribute("width", c.w), e.style.display = ""; var p = c.w, f = c.h, u = l, C = s, m = []; for (console.log("vh: " + d); u < h;) {
    for (; C < d;) {
        var O = [u, C, h, d];
        O = O.join(), m.push({ vb: O, innerSize: c, size: g }), C += c.h, i < (f += c.h) && (f = i);
    }
    u += c.w, r < (p += c.w) && (p = r), C = s;
} return m; }, void 0 === OrgChart && (OrgChart = {}), OrgChart.events = function () { var o = {}; return { on: function (t, e, r) { Array.isArray(o[t]) || (o[t] = []), o[t].push({ listener: e, event_id: r }); }, removeAll: function (t) { Array.isArray(o[t]) || (o[t] = []), o[t] = []; }, publish: function (t, e) { if (o[t]) {
        ...
        if (0 < r.length) {
            ...
            for (i = 0; i < r.length; i++)
                1 == e.length ? n = r[i](e[0]) && n : 2 == e.length ? n = r[i](e[0], e[1]) && n : 3 == e.length ? n = r[i](e[0], e[1], e[2]) && n : 4 == e.length ? n = r[i](e[0], e[1], e[2], e[3]) && n : 5 == e.length && (n = r[i](e[0], e[1], e[2], e[3], e[4]) && n);
            return n;
        }
    } } }; }(), OrgChart.prototype.importCSV = function () { var h = this, t = document.createElement("INPUT"); t.setAttribute("type", "file"), t.setAttribute("accept", ".csv"), t.style.display = "none", t.onchange = function (t) { var e = t.target, s = new FileReader; s.onload = function () { for (var t = s.result, e = OrgChart._csvToArray(t, ","), r = [], i = 1; i < e.length; i++) {
...
} }, OrgChart.prototype._maxMinHandler = function (t) { this.nodeMenuUI.hide(), this.nodeContextMenuUI.hide(), this.dragDropMenuUI.hide(), this.menuUI.hide(); var e = this.getBGNode(t); if (e.groupState == OrgChart.EXPAND) {
    ...
    if (!1 === OrgChart.events.publish("expcollclick", [this, OrgChart.EXPAND, t]))
        return !1;
    this.maximize(t);
} }, String.prototype.replaceAll = function (t, e) { return this.replace(new RegExp(t, "g"), e); }, String.prototype.splice = function (t, e, r) { return this.slice(0, t) + r + this.slice(t + Math.abs(e)); }, "function" != typeof Object.assign && Object.defineProperty(Object, "assign", { value: function (t, e) {
        "use strict";
        if (null == t)
        ...
        return r;
    }, writable: !0, configurable: !0 }), "function" != typeof String.prototype.endsWith && (String.prototype.endsWith = function (t) { return -1 !== this.indexOf(t, this.length - t.length); }), OrgChart.prototype._globalMouseDownHandler = function (t, e) { var r = { move: "mousemove", up: "mouseup", leave: "mouseleave" }; if (-1 != e.type.indexOf("touch") && (1 == e.touches.length ? this._touch = { x: e.touches[0].clientX, y: e.touches[0].clientY } : this._touch = null, r = { move: "touchmove", up: "touchend", touchstart: "touchstart" }), t == e.target)
    return e.stopPropagation(), e.preventDefault(), void this._mouseDownHandler(t, e, r); for (var i = e.target; i != t;) {
    if (i.hasAttribute("node-id"))
        return e.stopPropagation(), e.preventDefault(), void this._nodeMouseDownHandler(i, e, r);
    i = i.parentNode;
} }, OrgChart.prototype._globalClickHandler = function (t, e) { if (-1 != e.type.indexOf("touch") && this._touch && 1 == e.changedTouches.length) {
    if (e.changedTouches.length) {
        var r = e.changedTouches[0].clientX, i = e.changedTouches[0].clientY, a = OrgChart.t(this.config.template, this.getScale()).size, n = this.getScale(), o = Math.abs(r - this._touch.x) / n, l = Math.abs(i - this._touch.y) / n;
        if (this._touch = null, o > a[0] / 10)
            return;
        if (l > a[1] / 10)
            return;
    }
    ...
    var d = this, c = this.getSvg(), g = { x: r.x, y: r.y }, p = OrgChart._getTransform(t), f = p[4], u = p[5], C = d.getScale(), m = t.cloneNode(!0);
    ...
    var O = function (t, e) { if (null != t) {
        var r = d.getBGNode(t);
        r.isChildOfGroup && (d.getNodeElement(r._groupParentNodeId).style.opacity = 1), e.style.opacity = 1;
    } }, v = function (t) { var e = OrgChart._getClientXY(t), r = document.elementFromPoint(e.x, e.y); if (O(s, h), h = s = null, d.config.enableDragDrop)
        for (; null != r && r != c;) {
            if (r.hasAttribute("node-id")) {
                var i = r.getAttribute("node-id");
    ...
    } var n = (e.x - g.x) / C, o = (e.y - g.y) / C; p[4] = f + n, p[5] = u + o, m.setAttribute("transform", "matrix(" + p.toString() + ")"); }, x = function (t) { if (c.removeEventListener(o.move, v), c.removeEventListener(o.up, x), o.leave && c.removeEventListener(o.leave, x), l.id == s || l.isChildOfGroup && l._groupParentNodeId == s || null == s)
        return O(s, h), c.removeChild(m), void (d._gragStartedId = null); var e = d.getBGNode(s); if (e.isChildOfGroup && l.isChildOfGroup && e._groupParentNodeId == l._groupParentNodeId)
        return O(s, h), c.removeChild(m), void (d._gragStartedId = null); if (!1 === OrgChart.events.publish("drop", [d, l.id, e.id]))
        return O(s, h), c.removeChild(m), void (d._gragStartedId = null); if (null == d.config.dragDropMenu || l.isGroup && !e.isGroup)
        ...
        c.removeChild(m); d._gragStartedId = null; };
    c.addEventListener(o.move, v), c.addEventListener(o.up, x), o.leave && c.addEventListener(o.leave, x);
} }, OrgChart.prototype._resizeHandler = function (t, e) { var r = this.getViewBox(), i = this.getSvg(), a = i.getAttribute("width"), n = i.getAttribute("height"), o = a / r[2], l = n / r[3], s = l < o ? l : o; i.setAttribute("width", this.width()), i.setAttribute("height", this.height()), r[2] = this.width() / s, r[3] = this.height() / s, this.setViewBox(r), this.xScrollUI.create(this.width()), this.yScrollUI.create(this.height()), this._draw(!1, OrgChart.action.resize); }, OrgChart.prototype._nodeDbClickHandler = function (t, e) { if (!1 === OrgChart.events.publish("dbclick", [this, this.get(t)]))
    return !1; this._commonClickHandler(t, e, this.config.nodeMouseDbClick); }, OrgChart.prototype._nodeClickHandler = function (t, e) { if (!1 === OrgChart.events.publish("click", [this, this.get(t)]))
    return !1; this._commonClickHandler(t, e, this.config.nodeMouseClick); }, OrgChart.prototype._commonClickHandler = function (t, e, r) { this.searchUI.hide(), this.nodeMenuUI.hide(), this.nodeContextMenuUI.hide(), this.dragDropMenuUI.hide(), this.menuUI.hide(); var i = this.getBGNode(t); if (r == OrgChart.action.expandCollapse) {
    ...
    OrgChart.remote._fromResDTO(t.children[l], e, r, i); }, OrgChart.remote._find = function (t, r) { var i; return t.some(function t(e) { return e.id === r ? (i = e, !0) : e.children.some(t); }), i; }, OrgChart.remote._toReqDTO = function (t, e, r) { var i = { p: [t.id, null != t.parent ? t.parent.id : null, t.w, t.h] }; 0 < t.children.length && (i.c = OrgChart.remote._convertToIdArray(t.children)), null != t.layout && 0 != t.layout && (i.l = t.layout), t.isAssistant && (i.a = 1), t.templateName != r && (i.t = t.templateName), e.push(i); for (var a = 0; a < t.children.length; a++)
    OrgChart.remote._toReqDTO(t.children[a], e, r); }, OrgChart.remote._convertToIdArray = function (t) { for (var e = [], r = 0; r < t.length; r++)
    e.push(t[r].id); return e; }, OrgChart.remote._walk = function (r, t, i) { for (var e = [], a = [], n = [t.orientation, t.levelSeparation, t.mixedHierarchyNodesSeparation, t.subtreeSeparation, t.siblingSeparation, t.template], o = 0; o < r.length; o++)
    a.push(r[o].id), OrgChart.remote._toReqDTO(r[o], e, t.template); var l = { n: e, c: n, r: a, v: "4.5.6" }; OrgChart.LIMIT_NODES || (l.l = !0), null != OrgChart.remote._fromReqDTO ? OrgChart.remote._fromReqDTO(l.n, l.r, l.c, function (t) { for (var e = 0; e < r.length; e++)
    OrgChart.remote._fromResDTO(r[e], t, 0, r); i(); }) : (l = JSON.stringify(l), OrgChart.idb.read(l, function (t, e) { t ? OrgChart.remote._proceed(r, e.res, i) : OrgChart.remote._findRegion(function (t) { OrgChart._ajax(t, "post", l, "json", function (t) { t.error ? i(2) : (OrgChart.remote._proceed(r, t, i), OrgChart.idb.write({ id: l, res: t })); }); }); })); }, OrgChart.remote._proceed = function (t, e, r) { if ("string" == typeof e && (e = JSON.parse(e)), e.limit && 1 == e.limit)
    r(e.limit);
else {
    for (var i = 0; i < t.length; i++)
        OrgChart.remote._fromResDTO(t[i], e, 0, t);
    r();
} }, OrgChart.remote.getItem = function (t) { return OrgChart._browser().msie || OrgChart._browser().edge ? OrgChart.remote[t] : localStorage.getItem(t); }, OrgChart.remote.setItem = function (t, e) { OrgChart._browser().msie || OrgChart._browser().edge ? OrgChart.remote[t] = e : localStorage.setItem(t, e); }, OrgChart.remote._findRegion = function (r) { var t = OrgChart.remote.getItem("funcUrl"); if (t)
    r(t);
else {
    ...
    this.oldNodes = f || null, this._read(function (t) { h = t.maxX, d = t.maxY, c = t.minX, g = t.minY, p = t.roots[0], f = t.nodes, u = t.groupChildren; var e = OrgChart.server._getResponse(r, i, s.visibleNodes, s.config, h, d, c, g, s.viewBox, p, s.action, s.actionParams, f, u, s.oldNodes); e.notif = t.limit, a != OrgChart.action.exporting && (s.maxX = h, s.maxY = d, s.minX = c, s.minY = g, s.root = p, s.nodes = f, s.groupChildren = u, s.visibleNodes = e.visibleNodes), o(e); }, l); }, OrgChart.server.prototype._read = function (a, t) { var n = this, o = OrgChart.server._createNodes(this.config, this.action, this.actionParams, this.oldNodes); t(o); var l = o.nodes, s = o.roots, e = OrgChart.remote; null == e && (e = OrgChart.local), e._walk(s, this.config, function (t) { OrgChart.server._doNotChangePositionOfClickedNodeIfAny(s, l, n.action, n.actionParams, n.oldNodes, n.config.orientation); var e = { minX: null, minY: null, maxX: null, maxY: null }; for (var r in l) {
    var i = l[r];
    OrgChart.server._setMinMaxXY(i, e);
} a({ minX: e.minX, minY: e.minY, maxX: e.maxX, maxY: e.maxY, nodes: l, roots: s, groupChildren: o.groupChildren, limit: t }); }); }, OrgChart.server.prototype.find = function (t) { var r = this; if (null == t || null == t || "" == t)
    return []; t = OrgChart.accentFold(t); for (var e, i, a, n = function (t) { for (var e in r.config.nodeBinding)
    if (r.config.nodeBinding[e] == t)
        return !0; return !1; }, o = [], l = [], s = 0; s < this.config.nodes.length; s++) {
    var h = this.config.nodes[s];
    for (var d in h) {
        var c = h[d];
        0 < this.config.searchFields.length && -1 == this.config.searchFields.indexOf(d) || c && -1 != OrgChart.accentFold(c).indexOf(t) && !OrgChart._fieldIsImg(this.config, d) && o.push({ id: h.id, propertyName: d, isId: d == OrgChart.ID, isNodeParam: n(d), weight: OrgChart.accentFold(c).indexOf(t), data: h });
    }
} o.sort(function (t, e) { return 1 == t.isId && 0 == e.isId ? -1 : 1 == e.isId && 0 == t.isId ? 1 : 1 == t.isNodeParam && 0 == e.isNodeParam ? -1 : 1 == e.isNodeParam && 0 == t.isNodeParam ? 1 : t.weight < e.weight ? -1 : t.weight > e.weight ? 1 : 0; }); for (s = 0; s < o.length && 10 != s; s++) {
    ...
    if (!g) {
        ...
        l.push({ id: o[s].id, node: new OrgChart.node(o[s], null, null, [], v), textId: u, textInNode: f, text: C, img: m });
    }
} return l; }, void 0 === OrgChart && (OrgChart = {}), OrgChart.server._createNodes = function (t, e, r, i) { for (var a = t.nodes, n = {}, o = [], l = [], s = [], h = {}, d = !1, c = 0; c < a.length; c++) {
    var g = a[c], p = Array.isArray(g.tags) ? g.tags.slice(0) : [], f = OrgChart._getGroup(p, t.tags), u = OrgChart._getTemplate(p, t.tags, t.template), C = Array.isArray(g.spids) ? g.spids : null;
    if ((x = new OrgChart.node(g.id, g.pid, C, p, u)).isAssistant = -1 != p.indexOf("assistant"), x.isAssistant && -1 == s.indexOf(x.pid) && s.push(x.pid), null != f) {
        ...
        x.isChildOfGroup = !0, x._groupParentNodeId = f.name, n[f.name].bgnodes.push(x), 1 == x.isAssistant && (n[f.name].isAssistant = !0), h[x.id] = f.name, d = !0;
    }
    else
        null != t.orderBy && (x.order = g[t.orderBy]), n[g.id] = x, o.push(g.id);
} if (null != t.orderBy && o.sort(function (t, e) { var r = n[t].order, i = n[e].order; return "number" == typeof r || "number" == typeof i ? (null == r && (r = -1), null == i && (i = -1), r - i) : "string" == typeof r || "string" == typeof i ? (null == r && (r = ""), null == i && (i = ""), r.localeCompare(i)) : void 0; }), d)
    for (c = 0; c < o.length; c++) {
        h[(x = n[o[c]]).pid] && (x.pid = h[x.pid]);
    } var O = []; for (c = 0; c < o.length; c++) {
    var v = o[c], x = n[v], y = i ? i[v] : null;
    if (null != x.pid && null != x.pid && "" !== x.pid)
        (_ = n[x.pid]) ? ((x.parent = _).children.push(x), _.childrenIds.push(x.id)) : (x.pid = null, x.parent = null, l.push(x));
    else
        l.push(x);
    e == OrgChart.action.exporting && null != r.id && (l = [n[r.id]]), y ? (x.state = y.state, x.state == OrgChart.COLLAPSE && O.push(x.id), OrgChart.server._setNodeGroupState(x, y.groupState, t.orientation)) : OrgChart.server._setNodeGroupState(x, OrgChart.EXPAND, t.orientation), OrgChart.server._initStates(x, n, e, t, r, O), OrgChart.server._initGroupStates(x, n, e, t, r);
} if (null != t.roots) {
    l = [];
    ...
    (n[k.id] = k).isAssistant = !0, (y = i[k.id]) && (n[k.id].state = y.state, n[k.id].state == OrgChart.COLLAPSE && O.push(k.id)), OrgChart.server._initStates(k, n, e, t, r, O);
    var A = [];
    ...
    if (A.length % 2) {
        ...
        OrgChart.templates[N] = { linkAdjuster: {}, link: "", node: "", nodeMenuButton: "", size: I }, (W = new OrgChart.node(_.id + "_transperant", S.pid, null, [], N)).isAssistant = !0, n[W.id] = W, A.splice(A.length - 1, 0, W.id);
    }
    var M = 1;
    for (w = A.length - 1; 0 <= w; w--) {
        if (w % 2 && w != A.length - 1)
            (J = new OrgChart.node(_.id + "_split_" + M, null, null, [], "split")).isAssistant = !0, n[J.id] = J, A.splice(w, 0, J.id), M++;
        else
            w % 2 && A.splice(w, 0, k.id);
    }
    for (w = 0; w < A.length; w += 3) {
        ...
        for (var P = E; "split" == P.templateName && (P = P.parent);)
            P.childrenIds.push(L.id), P.childrenIds.push(B.id), P.childrenIds.push(T.id);
    }
} if (e == OrgChart.action.centerNode) {
    var H = n[r.id];
    H || (H = n[h[r.id]], OrgChart.server._setNodeGroupState(H, OrgChart.EXPAND, t.orientation)), H.state = OrgChart.EXPAND, -1 != (D = O.indexOf(H.id)) && O.splice(D, 1);
    _ = OrgChart.server._getRealParent(H);
    for (var z = H.id; null != _;) {
        if (-1 != (D = O.indexOf(_.id)) && O.splice(D, 1), _.state = OrgChart.EXPAND, r.options.parentState === OrgChart.COLLAPSE_PARENT_NEIGHBORS)
            for (c = 0; c < _.childrenIds.length; c++) {
                ...
                if (!OrgChart.server._isSplit(U) && !U.isAssistant && U.id != z)
                    -1 == (D = O.indexOf(_.childrenIds[c])) && O.push(_.childrenIds[c]), U.state = OrgChart.COLLAPSE;
            }
        if (_.state == OrgChart.EXPAND)
            for (var F = 0; F < _.childrenIds.length; F++) {
                ...
                if (OrgChart.server._isSplit(j) || j.isAssistant)
                    -1 != (D = O.indexOf(j.id)) && O.splice(D, 1), j.state = OrgChart.EXPAND;
            }
    ...
    if (r.options.childrenState === OrgChart.COLLAPSE_SUB_CHILDRENS)
        for (c = 0; c < H.childrenIds.length; c++) {
            if (-1 != (D = O.indexOf(H.childrenIds[c])) && O.splice(D, 1), (U = n[H.childrenIds[c]]).state = OrgChart.EXPAND, !U.isAssistant && !OrgChart.server._isSplit(U))
...
} e == OrgChart.action.exporting && 1 == r.expandChildren && x && (O = []); for (c = 0; c < O.length; c++) {
    if (_ = (x = n[O[c]]).parent)
        for (w = _.children.length - 1; 0 <= w; w--) {
            if (_.children[w] == x)
        ...
        if (0 == (x = n[o[c]]).childrenIds.length && !x.isAssistant && "split" != x.templateName)
            if (_ = x.parent) {
                if (!OrgChart.server._mixedLayoutAllNodes(_))
                    continue;
                for (w = _.children.length - 1; 0 <= w; w--) {
                    if ((U = _.children[w]) != x && 0 == U.childrenIds.length && !U.isAssistant && "split" != U.templateName) {
                        U.parent = x, U.pid = x.id, U.layout = OrgChart.mixed, _.children.splice(w, 1);
                        var Y = x.children.length;
                        x.children[Y] = U, x.layout = OrgChart.mixed;
                    }
                }
            }
    ...
    for (c = 0; c < o.length; c++) {
        if (0 == (x = n[o[c]]).childrenIds.length && !x.isAssistant && "split" != x.templateName)
            (_ = x.parent) && -1 == q.indexOf(_.id) && q.push(_.id);
    }
    for (c = 0; c < q.length; c++) {
            ...
            if (OrgChart.server._mixedLayoutAllNodes(_))
                if (0 == (U = _.children[w]).childrenIds.length && !U.isAssistant && "split" != U.templateName && (U.parent && "split" != U.parent.templateName || U.parent.isAssistant)) {
                    if ((U = _.children[w]).parent = null, U.layout = OrgChart.tree, _.children.splice(w, 1), _.childrenIds.splice(w, 1), t.layout == OrgChart.treeRightOffset && V.splice(0, 0, U.id), t.layout == OrgChart.treeLeftOffset || t.layout == OrgChart.treeRightOffset) {
                        ...
                        OrgChart.templates[N] = { linkAdjuster: {}, link: "", node: "", nodeMenuButton: "", size: [0, 0] }, (W = new OrgChart.node(U.id + "_transperant", null, null, [], N)).layout = OrgChart.tree, n[W.id] = W, V.splice(0, 0, W.id);
                    }
        ...
        for (M = 1, w = V.length - 1; 0 <= w; w--) {
            var J;
            if (w % 2 && w != V.length - 1)
                (J = new OrgChart.node(_.id + "_split_" + M, null, null, [], "split")).layout = OrgChart.tree, n[J.id] = J, V.splice(w, 0, J.id), M++;
            else
                w % 2 && V.splice(w, 0, k.id);
        }
...
} return { nodes: n, roots: l, groupChildren: h }; }, OrgChart.server._mixedLayoutAllNodes = function (t) { if (OrgChart.MIXED_LAYOUT_ALL_NODES)
    return !0; for (var e = t.children.length - 1; 0 <= e; e--) {
    var r = t.children[e];
    if (0 < r.childrenIds.length || r.isAssistant || "split" == r.templateName)
        return !1;
} return !0; }, OrgChart.server._isSplit = function (t) { return !!t && "split" == t.templateName; }, OrgChart.server._getRealParent = function (t) { if (!t)
    return null; if (!t.parent)
    return null; if ("split" != t.parent.templateName)
    return t.parent; for (var e = t.parent; e && "split" == e.templateName;)
    e = e.parent; return e; }, OrgChart.server._initStates = function (t, e, r, i, a, n) { if (r == OrgChart.action.init && t) {
    if (t.tags)
    ...
    t.state = a.state;
} }, OrgChart.server._expandCollapseToLevel = function (t, e, r, i, a, n) { if (i.collapse.level) {
    var o = 0;
...
} }, OrgChart.server._initGroupStates = function (t, e, r, i, a) { if (r == OrgChart.action.exporting && 1 == a.expandChildren && t)
...
} }, OrgChart.server._initNodeSize = function (t, e, r) { var i = OrgChart.t(e), a = i.size[0], n = i.size[1]; if (t.isGroup && t.groupState == OrgChart.EXPAND) {
    ...
    if (0 == i.layout_type)
        switch (r) {
            ...
            case OrgChart.orientation.bottom_left:
                ...
                for (var c = 0; c < t.bgnodes.length; c++)
                    h = Math.max(t.bgnodes[c].w, h), d = Math.max(t.bgnodes[c].h, d), n += t.bgnodes[c].h + i.groupNodesSeparation;
            ...
            case OrgChart.orientation.left_top:
                ...
                for (c = 0; c < t.bgnodes.length; c++)
                    h = Math.max(t.bgnodes[c].w, h), d = Math.max(t.bgnodes[c].h, d), a += t.bgnodes[c].w + i.groupNodesSeparation;
        ...
        switch (r) {
            ...
            case OrgChart.orientation.bottom_left:
                ...
                for (c = 0; c < t.bgnodes.length; c++)
                    h = Math.max(t.bgnodes[c].w, h), d = Math.max(t.bgnodes[c].h, d);
...
} t.w = a, t.h = n; }, OrgChart.server._setNodeGroupState = function (t, e, r) { t.groupState = e, OrgChart.server._initNodeSize(t, t.templateName, r); }, OrgChart.server._getNodeWidth = function (t, e) { switch (e.orientation) {
    case OrgChart.orientation.top:
    case OrgChart.orientation.top_left:
    case OrgChart.orientation.bottom:
    case OrgChart.orientation.bottom_left: return t.w;
    case OrgChart.orientation.right:
    case OrgChart.orientation.right_top:
    case OrgChart.orientation.left:
    case OrgChart.orientation.left_top: return t.h;
} return 0; }, OrgChart.server._isVisible = function (t, e, r, i) { if (null != t.x && null != t.y) {
    if (e.lazyLoading && i !== OrgChart.action.exporting) {
        function a(t, e) { var r = t.x, i = t.y, a = t.w, n = t.h, o = e[0] - OrgChart.LAZY_LOADING_FACTOR, l = e[2] + OrgChart.LAZY_LOADING_FACTOR + e[0], s = e[1] - OrgChart.LAZY_LOADING_FACTOR, h = e[3] + OrgChart.LAZY_LOADING_FACTOR + e[1], d = o < r + a && r < l; return d && (d = s < i + n && i < h), d; }
        if (a(t, r))
            return !0;
    ...
    e.push(t.nodeBinding[r]); for (r = 0; r < t.nodes.length; r++)
    for (var i in t.nodes[r])
        i !== OrgChart.ID && i !== OrgChart.TAGS && i !== OrgChart.NODES && i !== OrgChart.PID && (t.nodeBinding[i] || OrgChart._arrayContains(e, i) || e.push(i)); return e; }, OrgChart.server._doNotChangePositionOfClickedNodeIfAny = function (t, e, r, i, a, n) { if (r == OrgChart.action.expandCollapse || r == OrgChart.action.groupMaxMin || r == OrgChart.action.centerNode || r == OrgChart.action.update || r == OrgChart.action.insert) {
        ...
        if (c) {
            ...
            for (var o in e)
                switch (n) {
                    ...
                    case OrgChart.orientation.right_top:
                    case OrgChart.orientation.left:
                    case OrgChart.orientation.left_top: e[o].y += p;
                }
        }
    }
} }, OrgChart.server._getMostDeepChild = function (t) { if (t) {
    var i = t;
    return function t(e) { e.level > i.level && (i = e); for (var r = 0; r < e.children.length; r++)
        t(e.children[r]); }(t), i;
} }, OrgChart.server._setGroupNodes = function (t, e) { if (t.isGroup && t.groupState == OrgChart.EXPAND) {
...
} }, OrgChart.server._getResponse = function (t, e, r, i, a, n, o, l, s, h, d, c, g, p, f) { var u = {}, C = { top: null, left: null, bottom: null, right: null, minX: null, maxX: null, minY: null, maxY: null }, m = [[], [], []], O = a - o + 2 * i.padding, v = n - l + 2 * i.padding, x = OrgChart.getScale(s, t, e, i.scaleInitial, O, v); if (C.top = l - i.padding, C.left = o - i.padding, C.bottom = n + i.padding - e / x, C.right = a + i.padding - t / x, C.maxX = a, C.minX = o, C.maxY = n, C.minY = l, null == s && i.align == OrgChart.CENTER) {
    var y = Math.ceil(t / x), b = Math.ceil(e / x), w = 0, _ = 0;
    if (y - 2 * i.padding >= a - o)
        switch (w = (a + o) / 2 - y / 2, i.orientation) {
            case OrgChart.orientation.right:
            case OrgChart.orientation.right_top: w = (o - a) / 2 - y / 2;
        }
    else
        switch (w = h.x - y / 2 + OrgChart.server._getNodeWidth(h, i) / 2, i.orientation) {
            case OrgChart.orientation.right:
            case OrgChart.orientation.right_top:
            ...
            case OrgChart.orientation.bottom_left:
            case OrgChart.orientation.top_left:
            case OrgChart.orientation.left_top: (w = -(y / 2 - (a - o) / 2)) > -i.padding && (w = -i.padding);
        }
    if (b - 2 * i.padding >= n - l)
        switch (_ = (n + l) / 2 - b / 2, i.orientation) {
            case OrgChart.orientation.bottom:
            case OrgChart.orientation.bottom_left: _ = (l - n) / 2 - b / 2;
        }
    else
        switch ((_ = -(b / 2 - (n - l) / 2)) > -i.padding && (_ = -i.padding), i.orientation) {
            case OrgChart.orientation.bottom:
            case OrgChart.orientation.bottom_left:
                (_ = -(b / 2 - (l - n) / 2)) < i.padding - b && (_ = i.padding - b);
                break;
            case OrgChart.orientation.left:
            case OrgChart.orientation.right: _ = h.y - b / 2 + OrgChart.server._getNodeWidth(h, i) / 2;
        }
    s = [w, _, y, b];
}
    ...
    switch (i.orientation) {
        ...
        case OrgChart.orientation.left_top:
            w = -i.padding, _ = -i.padding;
            break;
        case OrgChart.orientation.bottom_left: w = -i.padding, _ = i.padding - b;
    }
    s = [w, _, y, b];
} d == OrgChart.action.centerNode && ((B = g[c.id]) || (B = g[p[c.id]]), 1 == c.options.horizontal && (s[0] = B.x + B.w / 2 - s[2] / 2), 1 == c.options.vertical && (s[1] = B.y + B.h / 2 - s[3] / 2), i.sticky && (s[0] < C.left && s[0] < C.right && (s[0] = C.left > C.right ? C.right : C.left), s[0] > C.right && s[0] > C.left && (s[0] = C.left > C.right ? C.left : C.right), s[1] < C.top && s[1] < C.bottom && (s[1] = C.top > C.bottom ? C.bottom : C.top), s[1] > C.bottom && s[1] > C.top && (s[1] = C.top > C.bottom ? C.top : C.bottom))); if (d == OrgChart.action.insert || d == OrgChart.action.expandCollapse || d == OrgChart.action.update || d == OrgChart.action.centerNode) {
    var k = null;
    if (d == OrgChart.action.insert && c && null != c.insertedNodeId && null != c.insertedNodeId)
        ...
        (k = g[c.id]) || (k = g[p[c.id]]), k = OrgChart.server._getMostDeepChild(k, g);
        ...
        switch (i.orientation) {
            ...
            case OrgChart.orientation.right_top:
            case OrgChart.orientation.left:
            case OrgChart.orientation.left_top: c.options.horizontal || (k = g[c.id]);
        }
    ...
    if (OrgChart.server._isVisible(I, i, s, d)) {
        ...
        if (d == OrgChart.action.expandCollapse && f && f[I.id] && "expandCollapseToLevel" == c.method) {
            if (N = { x: (T = f[I.id]).x, y: T.y }, T) {
                ...
                for (var M = I, E = null; null != M;)
                    f[M.id] && f[M.id].state == OrgChart.COLLAPSE && (E = M), M = M.parent;
                E && E.parent && (N = { x: E.parent.x, y: E.parent.y });
            }
            if (L = g[c.id]) {
                for (M = I.parent; null != M;)
                    M = M.parent;
            ...
            if (L = g[c.id]) {
                for (M = I.parent; null != M && -1 == c.ids.indexOf(I.id) && -1 == c.ids.indexOf(M.id);)
                    M = M.parent;
                M && (N = { x: L.x + L.w / 2 - I.w / 2, y: L.y + L.h / 2 - I.h / 2 });
            }
        }
            ...
            var B;
            if (null != (T = f[I.id]).x && null != T.y && (N = { x: T.x, y: T.y }), (B = g[c.id]) && B == I)
                (M = I.parent) && M.id == c.id && (N = { x: B.x + B.w / 2 - I.w / 2, y: B.y + B.h / 2 - I.h / 2 });
        }
            ...
            N = { x: I.parent.x, y: I.parent.y };
        else if ((d == OrgChart.action.update || d == OrgChart.action.insert) && f && f[I.id]) {
            var T;
            N = { x: (T = f[I.id]).x, y: T.y };
        }
        else
            d !== OrgChart.action.exporting && r && !r[I.id] && (m[0].push(I.id), m[1].push({ opacity: 0 }), m[2].push({ opacity: 1 }));
    ...
    } return d; }, expandCollapse: function (t, e, r, i) { if (r === OrgChart.action.exporting)
        return ""; if (0 == t.childrenIds.length)
        return ""; if (t.isAssistant)
        return ""; if ("split" == t.templateName)
        return ""; var a = "", n = 0, o = 0, l = OrgChart.t(t.templateName, i); switch (e.orientation) {
        case OrgChart.orientation.top:
        case OrgChart.orientation.top_left:
        ...
        case OrgChart.orientation.right_top:
            ...
            break;
        case OrgChart.orientation.left:
        case OrgChart.orientation.left_top: n = t.x + t.w, o = t.y + t.h / 2;
    } return n -= l.expandCollapseSize / 2, o -= l.expandCollapseSize / 2, t.collapsedChildrenIds.length ? (a += OrgChart.expcollOpenTag.replace("{id}", t.id).replace("{x}", n).replace("{y}", o), a += l.plus) : (a += OrgChart.expcollOpenTag.replace("{id}", t.id).replace("{x}", n).replace("{y}", o), a += l.minus), a += OrgChart.grCloseTag; }, secondLinks: function (t, e, r, i, a) { if (null == e.spids)
        return ""; for (var n = "", o = 0; o < e.spids.length; o++) {
        ...
        if (t[s]) {
            switch (r.orientation) {
                ...
                case OrgChart.orientation.left_top:
                case OrgChart.orientation.right:
                case OrgChart.orientation.right_top: d = "top", t[s].y > e.y && (d = "bottom");
            }
            ...
            var p = { p: e.x + e.w / 2 + c.expandCollapseSize, q: e.y, r: e.x + e.w / 2 + c.expandCollapseSize, s: i.minY + g };
            switch (r.orientation) {
                case OrgChart.orientation.top:
                case OrgChart.orientation.top_left:
                ...
                case OrgChart.orientation.left_top:
                    ...
                    break;
                case OrgChart.orientation.right:
                case OrgChart.orientation.right_top: p.p = e.x + e.w, p.q = e.y + e.h / 2 + c.expandCollapseSize, p.r = i.maxX + g, p.s = e.y + e.h / 2 + c.expandCollapseSize, l.push([p.p, p.q]), l.push([e.x + e.w + g / 3, p.q]);
            }
            for (var f = e; null == h;) {
                ...
                if (!u) {
                    var v = l[l.length - 1][0], x = 0;
                    if (C.parent)
                        switch (g = r.levelSeparation, C.parent.layout != OrgChart.mixed && C.parent.layout != OrgChart.tree || (g = r.mixedHierarchyNodesSeparation), r.orientation) {
                            case OrgChart.orientation.top:
                            case OrgChart.orientation.top_left:
                            ...
                            case OrgChart.orientation.left:
                            case OrgChart.orientation.left_top:
                                v = C.parent.x + C.parent.w + g * (2 / 3), x = l[l.length - 1][1];
                                break;
                            case OrgChart.orientation.right:
                            case OrgChart.orientation.right_top: v = C.parent.x - g * (2 / 3), x = l[l.length - 1][1];
                        }
                    l.push([v, x]);
                }
                f = C;
            ...
            switch (c = OrgChart.t(h.templateName, a), l.splice(l.length - 1, 1), r.orientation) {
                ...
                case OrgChart.orientation.left_top:
                    ...
                    break;
                case OrgChart.orientation.right:
                case OrgChart.orientation.right_top: l.push([l[l.length - 1][0], h.y + h.h / 2 + c.expandCollapseSize]), l.push([h.x, l[l.length - 1][1]]);
            }
            l[0] = "M" + l[0].join(",");
    ...
    } return n; }, link: function (t, e, r, i) { var a = OrgChart.t(t.templateName, i), n = [], o = r.levelSeparation / 2; t.layout != OrgChart.mixed && t.layout != OrgChart.tree || (o = r.mixedHierarchyNodesSeparation / 2); for (var l = 0; l < t.children.length; l++) {
        var s = t.children[l], h = { xa: 0, ya: 0, xb: 0, yb: 0, xc: 0, yc: 0, xd: 0, yd: 0, x: 0, y: 0, rotate: 0 }, d = (a = OrgChart.t(s.templateName, i)).link;
        if ((s.isAssistant || 2 == s.layout) && s.rightNeighbor && "split" == s.rightNeighbor.templateName)
            switch (r.orientation) {
                ...
                case OrgChart.orientation.right_top:
                    ...
                    break;
                case OrgChart.orientation.left:
                case OrgChart.orientation.left_top: h = OrgChart.ui._linkBottomToTop(s.rightNeighbor, s, a, o);
            }
            ...
            switch (r.orientation) {
                ...
                case OrgChart.orientation.right_top:
                    ...
                    break;
                case OrgChart.orientation.left:
                case OrgChart.orientation.left_top: h = OrgChart.ui._linkTopToBottom(s.leftNeighbor, s, a, o);
            }
        else
            switch (r.orientation) {
                case OrgChart.orientation.top:
                ...
                case OrgChart.orientation.right_top:
                    ...
                    break;
                case OrgChart.orientation.left:
                case OrgChart.orientation.left_top: h = OrgChart.ui._linkLeftToRight(t, s, a, o);
            }
...
} }, OrgChart._pinchMiddlePointInPercent = function (t, e, r, i) { var a = OrgChart._getTopLeft(t), n = i.touches[0].pageX - a.x, o = i.touches[0].pageY - a.y, l = i.touches[1].pageX - a.x, s = i.touches[1].pageY - a.y; return [((n - l) / 2 + l) / (e / 100), ((o - s) / 2 + s) / (r / 100)]; }, OrgChart._browser = function () { var t = navigator.userAgent; t = t.toLowerCase(); var e = /(webkit)[ \/]([\w.]+)/.exec(t) || /(opera)(?:.*version)?[ \/]([\w.]+)/.exec(t) || /(msie) ([\w.]+)/.exec(t) || t.indexOf("compatible") < 0 && /(mozilla)(?:.*? rv:([\w.]+))?/.exec(t) || [], r = e[1] || ""; e[2]; return { msie: -1 != navigator.userAgent.indexOf("Trident"), edge: -1 != navigator.userAgent.indexOf("Edge"), webkit: "webkit" == r, mozilla: "mozilla" == r, opera: "opera" == r }; }, OrgChart._menuPosition = function (t, e, r) { e.offsetX, e.offsetY; var i = t.getBoundingClientRect(), a = r.getBoundingClientRect(); return { x: i.left - a.left, y: i.top - a.top }; }, OrgChart._getTemplate = function (t, e, r) { if (Array.isArray(t))
    for (var i = 0; i < t.length; i++) {
        var a = e[t[i]];
        if (a && !a.group && a.template)
            return a.template;
    } return r; }, OrgChart._getGroup = function (t, e) { for (var r = 0; r < t.length; r++) {
    var i = e[t[r]];
    if (i && i.group && i.template)
        return { tag: i, name: t[r] };
} return null; }, OrgChart._isHTML = function (t) { var e = document.createElement("div"); e.innerHTML = t; for (var r = e.childNodes, i = r.length; i--;)
    if (1 == r[i].nodeType)
        return !0; return !1; }, OrgChart.wrapText = function (t, e) { if (-1 == e.indexOf("<text"))
    return t; if (-1 == e.indexOf("width"))
    return t; if (OrgChart._isHTML(t))
    return t; var r = document.getElementById("bg-tests"); r.innerHTML = "<svg>" + e + "</svg>"; var i = (new DOMParser).parseFromString(e, "text/xml").getElementsByTagName("text")[0], a = parseFloat(i.getAttribute("x")), n = parseFloat(i.getAttribute("y")), o = i.getAttribute("text-anchor"), l = i.getAttribute("width"), s = i.getAttribute("text-overflow"), h = "http://www.w3.org/2000/svg", d = r.getElementsByTagName("svg")[0].getElementsByTagName("text")[0]; if (!l)
    return t; if (l = parseFloat(l), a || (a = 0), n || (n = 0), a || (o = "start"), s || (s = "ellipsis"), "ellipsis" == s) {
    d.removeChild(d.firstChild), d.textContent = t;
    for (var c = d.getComputedTextLength(), g = 2; l < c;)
        d.textContent = t.substring(0, t.length - g), d.textContent += "...", c = d.getComputedTextLength(), g++;
    ...
    for (var m = 1; m < p.length; m++) {
        ...
        if (u.firstChild.data += " " + p[m], u.getComputedTextLength() > l)
            u.firstChild.data = u.firstChild.data.slice(0, O), (u = document.createElementNS(h, "tspan")).setAttributeNS(null, "x", a), u.setAttributeNS(null, "y", n + f * g), u.setAttributeNS(null, "text-anchor", o), C = document.createTextNode(p[m]), u.appendChild(C), d.appendChild(u), g++;
    }
    var v = "";
    if (null != d.innerHTML)
        ...
        for (m = d.childNodes.length - 1; 0 <= m; m--)
            x = XMLSerializer().serializeToString(d.childNodes[m]) + x, d.removeChild(d.childNodes[m]);
        v = x;
    }
    return v;
} }, OrgChart._downloadFile = function (t, e, r) { var i = new Blob([e], { type: t }); if (navigator.msSaveBlob)
...
} }, OrgChart._getPosition = function (t, e, r, i) { var a = { x: e.x, y: e.y }; if (null != r && (a.x = r), null != i && (a.y = i), t && 3 == t.length) {
    var n = t[0].indexOf(e.id);
    -1 != n && null != t[1][n].transform && (null == r && (a.x = t[1][n].transform[4]), null == i && (a.y = t[1][n].transform[5]));
} return a; }, OrgChart._getOpacity = function (t, e) { var r = 1; if (t && 3 == t.length) {
    var i = t[0].indexOf(e.id);
    -1 != i && null != t[1][i].opacity && (r = t[1][i].opacity);
} return r; }, OrgChart.t = function (t, e) { var r = OrgChart.templates[t], i = null; if (null != e && r.scaleLessThen) {
    var a = [];
    ...
    if (0 < a.length) {
        ...
        for (var s in l)
            null == i && (i = Object.assign({}, r)), i[s] = l[s];
    }
} return null == i ? r : i; }, OrgChart._imgs2base64 = function (t, e, i, a) { var n = t.getElementsByTagName(e), o = n.length; 0 == o && a(); for (var l = 0; l < o; l++)
    !function () { var e = l, r = n[e]; OrgChart._getDataUri(r.getAttribute(i), function (t) { t.success && r.setAttribute(i, t.result), e == o - 1 && a(); }); }(); }, OrgChart._getDataUri = function (t, e) { if (-1 != t.indexOf("base64"))
    e({ success: !1 });
else {
    var r = new XMLHttpRequest;
    r.open("GET", t), r.responseType = "blob", r.onload = function () { 200 === r.status ? i.readAsDataURL(r.response) : 404 === r.status && e({ success: !1, result: r.status }); };
    var i = new FileReader;
    i.onloadend = function () { e({ success: !0, result: i.result }); }, r.send();
} }, OrgChart._csvToArray = function (t, e) { e = e || ","; for (var r = new RegExp("(\\" + e + '|\\r?\\n|\\r|^)(?:"([^"]*(?:""[^"]*)*)"|([^"\\' + e + "\\r\\n]*))", "gi"), i = [[]], a = null; a = r.exec(t);) {
    var n, o = a[1];
    o.length && o !== e && i.push([]), n = a[2] ? a[2].replace(new RegExp('""', "g"), '"') : a[3], i[i.length - 1].push(n);
} return i; }, OrgChart._json2xml = function (t) { for (var e = document.implementation.createDocument("", "", null), r = e.createElement("nodes"), i = 0; i < t.length; i++) {
    ...
    r.appendChild(a);
} return e.appendChild(r), '<?xml version="1.0" encoding="utf-8" ?>' + (new XMLSerializer).serializeToString(e.documentElement); }, OrgChart._xml2json = function (t) { for (var e = (new DOMParser).parseFromString(t, "text/xml").getElementsByTagName("node"), r = [], i = 0; i < e.length; i++) {
    for (var a = e[i], n = {}, o = 0; o < a.attributes.length; o++) {
        var l = a.attributes[o], s = l.value;
        "tags" == l.name && (s = s.split(",")), n[l.name] = s;
    }
    r.push(n);
} return r; }, OrgChart._json2csv = function (t) { for (var n = [], e = function (t) { for (var e = "", r = 0; r < n.length; r++) {
    var i;
    ...
    for (var a in t[i])
        OrgChart._arrayContains(n, a) || (n.push(a), r += a + ","); r += "\n"; for (i = 0; i < t.length; i++)
    r += e(t[i]); return r; }, OrgChart.accentFold = function (t) { return (t = t.toString().toLowerCase()).replace(/([Ã Ã¡Ã¢Ã£Ã¤Ã¥])|([Ã§])|([Ã¨Ã©ÃªÃ«])|([Ã¬Ã­Ã®Ã¯])|([Ã±])|([Ã²Ã³Ã´ÃµÃ¶Ã¸])|([ÃŸ])|([Ã¹ÃºÃ»Ã¼])|([Ã¿])|([Ã¦])/g, function (t, e, r, i, a, n, o, l, s, h, d) { return e ? "a" : r ? "c" : i ? "e" : a ? "i" : n ? "n" : o ? "o" : l ? "s" : s ? "u" : h ? "y" : d ? "ae" : void 0; }); }, OrgChart.xScrollUI = function (t, e, r, i, a) { this.element = t, this.requestParams = r, this.config = e, this.onSetViewBoxCallback = i, this.onDrawCallback = a, this.pos = 0; }, OrgChart.xScrollUI.prototype.addListener = function (t) { var l = this; this.config.mouseScrool == OrgChart.action.xScroll && this.bar && function (t, i, e) { var a = !1; function r(t) { t.preventDefault(); var e = t.delta || t.wheelDelta; void 0 === e && (e = -t.detail), e = Math.max(-1, Math.min(1, e)), l.pos += -e * i; var r = parseFloat(l.innerBar.clientWidth) - parseFloat(l.bar.clientWidth); l.pos < 0 && (l.pos = 0), l.pos > r && (l.pos = r), a || n(); } function n() { a = !0; var t = (l.pos - l.bar.scrollLeft) / e; 0 < t ? t++ : t--, l.bar.scrollLeft += t, l.bar.scrollLeft == l.pos ? a = !1 : o(n); } t.addEventListener("mousewheel", r, !1), t.addEventListener("DOMMouseScroll", r, !1); var o = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function (t) { setTimeout(t, 20); }; }(t, 120, 12); }, OrgChart.xScrollUI.prototype.create = function (t) { var a = this; this.bar && this.bar.parentNode.removeChild(this.bar), this.bar = document.createElement("div"), this.innerBar = document.createElement("div"); this.requestParams(); this.innerBar.innerHTML = "&nbsp", Object.assign(this.bar.style, { position: "absolute", left: 0, bottom: 0, width: t + "px", "overflow-x": "scroll", height: "20px" }), this.element.appendChild(this.bar), this.bar.appendChild(this.innerBar), this.bar.addEventListener("scroll", function () { if (this.ignore)
    this.ignore = !1;
else {
    var t = a.requestParams(), e = (parseFloat(a.innerBar.clientWidth) - parseFloat(a.bar.clientWidth)) / 100, r = this.scrollLeft / e, i = (t.boundary.right - t.boundary.left) / 100;
    t.viewBox[0] = r * i + t.boundary.left, a.onSetViewBoxCallback(t.viewBox), clearTimeout(this._timeout), this._timeout = setTimeout(function () { a.onDrawCallback(); }, 500);
} }); }, OrgChart.xScrollUI.prototype.setPosition = function () { if (this.bar) {
    var t = this.requestParams(), e = (t.boundary.maxY, t.scale, Math.abs(t.boundary.maxX - t.boundary.minX) * t.scale);
    switch (this.config.orientation) {
        ...
        case OrgChart.orientation.bottom_left:
            ...
            break;
        case OrgChart.orientation.right:
        case OrgChart.orientation.right_top: e = Math.abs(t.boundary.minX * t.scale);
    }
    ...
    switch (this.config.orientation) {
        ...
        case OrgChart.orientation.bottom_left:
            ...
            break;
        case OrgChart.orientation.right:
        case OrgChart.orientation.right_top: Math.abs(t.boundary.minX * t.scale);
    }
    ...
    if (d && c) {
        ...
        var O = {}, v = {}, x = g + d.w / 2, y = f + c.w / 2, b = p + d.h / 2, w = u + c.h / 2, _ = 1;
        switch (this.config.orientation) {
            case OrgChart.orientation.top:
            case OrgChart.orientation.top_left:
            ...
            case OrgChart.orientation.left_top:
                ...
                break;
            case OrgChart.orientation.right:
            case OrgChart.orientation.right_top: O.y = b <= w ? (_ = 1, b + d.h / 5) : (_ = -1, b - d.h / 5), v.y = w + c.h / 5, g == f ? (_ = 1, O.x = g + d.w, v.x = f + c.w) : f < g ? (O.x = g, v.x = f + c.w) : (O.x = g + d.w, v.x = f);
        }
        ...
        var S = (r = O, a = k, void 0, n = ((i = v).x - r.x) / 2 + r.x, o = (i.y - r.y) / 2 + r.y, { x: (n - a.x) / 2 + a.x, y: (o - a.y) / 2 + a.y });
        h.label && (l += m.label.replace("{x}", S.x).replace("{y}", S.y).replace("{val}", h.label)), l += OrgChart.grCloseTag;
    }
    function I(t, e, r) { null == r && (r = 1); var i = e.x - t.x, a = e.y - t.y, n = Math.sqrt(Math.pow(e.x - t.x, 2) + Math.pow(e.y - t.y, 2)) / 3; return n = n / (Math.sqrt(i * i + a * a) * r) * OrgChart.CLINK_CURVE, { x: t.x + i / 2 - a * n, y: t.y + a / 2 + i * n }; }
} e.content += l; }, OrgChart.prototype.addClink = function (t, e, r, i) { return this.removeClink(t, e), this.config.clinks.push({ from: t, to: e, label: r, template: i }), this; }, OrgChart.prototype.removeClink = function (t, e) { for (var r = this.config.clinks.length - 1; 0 <= r; r--) {
